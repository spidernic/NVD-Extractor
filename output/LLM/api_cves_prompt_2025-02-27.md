# Api CVE Vulnerabilities Data

## Description
Vulnerabilities likely to affect externally facing APIs from the past 360 days (as of 2025-02-27).

## Vulnerabilities Count
1462 vulnerabilities found
...
Note: Only showing the first 50 of 1462 vulnerabilities to fit within context limits. Vulnerabilities are sorted by CVSS score (highest first).
