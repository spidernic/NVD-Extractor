# Critical CVE Vulnerabilities Data

## Description
All critical vulnerabilities with network attack vector from the past 360 days (as of 2025-02-27).

## Vulnerabilities Count
2110 vulnerabilities found
...
Note: Only showing the first 50 of 2110 vulnerabilities to fit within context limits. Vulnerabilities are sorted by CVSS score (highest first).
